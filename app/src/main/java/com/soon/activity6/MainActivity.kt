...
import com.soon.activity6.databinding.ActivityMainBinding
import com.soon.activity6.dialogs.CustomDialog
...
class MainActivity : AppCompatActivity() {
    ...
    */
    ...
    private fun customDialog() {
        ...
        customDialog.show()
        customDialog.binding.save.setOnClickListener {
            val enteredText = customDialog.binding.title.text.toString()
